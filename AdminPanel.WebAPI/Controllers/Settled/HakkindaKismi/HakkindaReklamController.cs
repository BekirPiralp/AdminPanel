...
{
    public class HakkindaReklamController : BaseController<IBusHakkindaReklam, HakkindaReklam>
    {
        public HakkindaReklamController() : base(BusOlusturucu.Olustur().HakkindaReklam)
        {
        }
    }
}
